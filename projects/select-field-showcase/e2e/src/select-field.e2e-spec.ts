...
describe('Select field', () => {
  ...
  it('should match previous single mode screenshot with validation', async (done) => {
    await element(by.css('#screenshot-select-field-single-mode .sky-input-group.sky-btn')).click();
    await element(by.css('.sky-modal-btn-close')).click();
    await element(by.css('body')).click();
    await SkyHostBrowser.moveCursorOffScreen();
    await SkyHostBrowser.scrollTo('#screenshot-select-field-single-mode-wrapper');
  ...
  it('should match previous single mode picker screenshot', async (done) => {
    ...
    expect('.sky-modal').toMatchBaselineScreenshot(async () => {
      await element(by.css('.sky-modal-btn-close')).click();
      done();
    }, {
  ...
  it('should match previous picker add new record button screenshot', async (done) => {
    await element(
      by.css('#screenshot-select-field-add-new-record-button .sky-input-group.sky-btn')
    ).click();

    await SkyHostBrowser.moveCursorOffScreen();

    expect('.sky-modal .sky-list-toolbar-search').toMatchBaselineScreenshot(async () => {
      await element(by.css('.sky-modal-btn-close')).click();
      done();
    }, {
