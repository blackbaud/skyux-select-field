...
import { SkySelectField } from 'projects/select-field/src/public-api';

@Component({
  selector: 'app-select-field-visual',
...
export class SelectFieldVisualComponent implements OnInit {
  ...
  public staticData = [
    ...
    },
    {
      ...
      label:
        'Strawberries that were picked in the dead of winter when the ground was covered with five inches of snow from a giant blizzard that blew through the area late at night.',
